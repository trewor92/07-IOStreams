...
namespace IOStreams.Tests
{
    ...
    public class UnitTests
    {
        ...
        private string ResourseFileName = Path.Combine(
            Directory.GetParent(Directory.GetCurrentDirectory()).Parent.FullName,"Resources", "Planets.xlsx");

        private string EncodedFileName = Path.Combine(
            Directory.GetParent(Directory.GetCurrentDirectory()).Parent.FullName, "Resources", "german_ISO-8859-1.txt");
